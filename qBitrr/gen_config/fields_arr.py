...
ARR_FIELDS: tuple[ConfigField, ...] = (
    ...
    ConfigField(
        ...
        (
            ...
            "A positive tracker MaximumETA overrides this value; tracker -1/unset does not clear this limit",
            "Unlimited only when neither this setting nor a matched tracker sets a positive MaximumETA",
        ),
        label="Maximum ETA",
        kind="duration",
        native_unit="seconds",
    ...
    ConfigField(
        ...
        (
            ...
            "Set this value to -1 to disable it (no limit from this source)",
            "A positive tracker MaxUploadRatio overrides this value; tracker -1/unset does not clear this limit",
            "Unlimited only when neither SeedingMode nor a matched tracker sets a positive ratio limit",
        ),
    ...
    ConfigField(
        ...
        -1,
        (
            'Set the maximum seeding time for torrents (seconds, or duration strings like "2w")',
            "Set this value to -1 to disable it (no limit from this source)",
            "A positive tracker MaxSeedingTime overrides this value; tracker -1/unset does not clear this limit",
            "Unlimited only when neither SeedingMode nor a matched tracker sets a positive time limit",
        ),
