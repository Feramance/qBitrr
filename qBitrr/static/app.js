...
try {
  if (typeof window !== 'undefined') {
    ...
    if (typeof loadProcesses === 'function') window.loadProcesses = loadProcesses;
    ...
    if (typeof applyLogLevel === 'function') window.applyLogLevel = applyLogLevel;
    if (typeof refreshLogList === 'function') window.refreshLogList = refreshLogList;
    if (typeof downloadCurrent === 'function') window.downloadCurrent = downloadCurrent;
    if (typeof loadArrList === 'function') window.loadArrList = loadArrList;
    if (typeof globalSearch === 'function') window.globalSearch = globalSearch;
    if (typeof renderConfigForms === 'function') window.renderConfigForms = renderConfigForms;
    if (typeof submitConfigForms === 'function') window.submitConfigForms = submitConfigForms;
    if (typeof addArrInstance === 'function') window.addArrInstance = addArrInstance;
    if (typeof loadRadarrAllInstances === 'function') window.loadRadarrAllInstances = loadRadarrAllInstances;
    if (typeof loadSonarrAllInstances === 'function') window.loadSonarrAllInstances = loadSonarrAllInstances;
    if (typeof loadRadarrAll === 'function') window.loadRadarrAll = loadRadarrAll;
    if (typeof loadSonarrAll === 'function') window.loadSonarrAll = loadSonarrAll;
  }
} catch (e) {
  /* ignore */
}
...
(function(){
  ...
  if (typeof window.radarrAggSearch !== 'function') {
    window.radarrAggSearch = function(q){ if(!window._radarrAgg) return; window._radarrAgg.q=q||''; window._radarrAgg.page=0; window.renderRadarrAgg(); };
  }
  ...
  if (typeof window.sonarrAggSearch !== 'function') {
    window.sonarrAggSearch = function(q){ if(!window._sonarrAgg) return; window._sonarrAgg.q=q||''; window._sonarrAgg.page=0; window.renderSonarrAgg(); };
  }
...
(function(){
  if (typeof window.addArrInstance !== 'function') {
    window.addArrInstance = function(type){
      ...
      let idx = 1; let key = `${prefix}-${idx}`;
      while (document.getElementById(`cfg_${key}_URI`)) { idx++; key = `${prefix}-${idx}`; }
