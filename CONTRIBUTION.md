...
## Common Pitfalls
- **Qbittorrent API v5**: Set `Settings.Qbittorrent.Version5 = true` in config for qBit 5.x
- **Tagging**: Radarr/Sonarr downloads MUST have tags matching `Settings.CategoryX` for qBitrr to track them
